...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Test_Upload.test_type'
        db.alter_column(u'main_test_upload', 'test_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Test_Upload.test_type'
        db.alter_column(u'main_test_upload', 'test_type', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 15, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
