...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PeerTeaching', fields ['profile']
        db.delete_unique(u'main_peerteaching', ['profile_id'])


        # Changing field 'PeerTeaching.profile'
        db.alter_column(u'main_peerteaching', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Profile'], null=True))

    def backwards(self, orm):

        # Changing field 'PeerTeaching.profile'
        db.alter_column(u'main_peerteaching', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Profile'], unique=True, null=True))
        # Adding unique constraint on 'PeerTeaching', fields ['profile']
        db.create_unique(u'main_peerteaching', ['profile_id'])
