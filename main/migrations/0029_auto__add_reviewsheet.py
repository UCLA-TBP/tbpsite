...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReviewSheet'
        db.create_table(u'main_reviewsheet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutoring.Class'], null=True)),
            ('reviewSheetFile', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True)),
        ))
        db.send_create_signal(u'main', ['ReviewSheet'])


    def backwards(self, orm):
        # Deleting model 'ReviewSheet'
        db.delete_table(u'main_reviewsheet')
    ...
    models = {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 1, 31, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
