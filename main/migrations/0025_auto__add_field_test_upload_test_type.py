...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Test_Upload.test_type'
        db.add_column(u'main_test_upload', 'test_type',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Test_Upload.test_type'
        db.delete_column(u'main_test_upload', 'test_type')
    ...
    models = {
        ...
        u'main.test_upload': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']", 'null': 'True', 'blank': 'True'}),
            'test_type': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '2'}),
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 11, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
