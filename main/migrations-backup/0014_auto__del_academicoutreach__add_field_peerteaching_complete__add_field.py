...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AcademicOutreach'
        db.delete_table(u'main_academicoutreach')

        # Adding field 'PeerTeaching.complete'
        db.add_column(u'main_peerteaching', 'complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeerTeaching.requirement_choice'
        db.add_column(u'main_peerteaching', 'requirement_choice',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)

        # Adding field 'PeerTeaching.tutoring'
        db.add_column(u'main_peerteaching', 'tutoring',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tutoring.Tutoring'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PeerTeaching.academic_outreach_complete'
        db.add_column(u'main_peerteaching', 'academic_outreach_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Candidate.requirement_choice'
        db.delete_column(u'main_candidate', 'requirement_choice')

        # Deleting field 'Candidate.requirement_complete'
        db.delete_column(u'main_candidate', 'requirement_complete')


    def backwards(self, orm):
        # Adding model 'AcademicOutreach'
        db.create_table(u'main_academicoutreach', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'main', ['AcademicOutreach'])

        # Deleting field 'PeerTeaching.complete'
        db.delete_column(u'main_peerteaching', 'complete')

        # Deleting field 'PeerTeaching.requirement_choice'
        db.delete_column(u'main_peerteaching', 'requirement_choice')

        # Deleting field 'PeerTeaching.tutoring'
        db.delete_column(u'main_peerteaching', 'tutoring_id')

        # Deleting field 'PeerTeaching.academic_outreach_complete'
        db.delete_column(u'main_peerteaching', 'academic_outreach_complete')

        # Adding field 'Candidate.requirement_choice'
        db.add_column(u'main_candidate', 'requirement_choice',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)

        # Adding field 'Candidate.requirement_complete'
        db.add_column(u'main_candidate', 'requirement_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 1, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
