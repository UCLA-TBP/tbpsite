# Django settings for tbpsite project.
import os
...
ADMINS = (
        ('webmaster', 'webmaster@tbp.seas.ucla.edu'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tbpsite',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'tbpsite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tbpsite.wsgi.application'
