...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tutoring_questions_comment', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'Question.related_class'
        db.add_column(u'tutoring_questions_question', 'related_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tutoring.Class']),
                      keep_default=False)
        ...
        db.alter_column(u'tutoring_questions_question', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Comment.pub_date'
        db.alter_column(u'tutoring_questions_comment', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Question.related_class'
        db.delete_column(u'tutoring_questions_question', 'related_class_id')
        ...
        # Changing field 'Question.pub_date'
        db.alter_column(u'tutoring_questions_question', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'tutoring_questions.question': {
            ...
            'related_class': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tutoring.Class']"}),
