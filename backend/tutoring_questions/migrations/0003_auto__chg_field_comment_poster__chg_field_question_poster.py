...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.poster'
        db.alter_column(u'tutoring_questions_comment', 'poster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Profile'], null=True))

        # Changing field 'Question.poster'
        db.alter_column(u'tutoring_questions_question', 'poster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Profile'], null=True))

    def backwards(self, orm):

        # Changing field 'Comment.poster'
        db.alter_column(u'tutoring_questions_comment', 'poster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Question.poster'
        db.alter_column(u'tutoring_questions_question', 'poster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
