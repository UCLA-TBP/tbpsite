...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Test_Upload.class_name'
        db.delete_column(u'main_test_upload', 'class_name')

        # Adding field 'Test_Upload.profile'
        db.add_column(u'main_test_upload', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Profile'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Test_Upload.course'
        db.add_column(u'main_test_upload', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutoring.Class'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Test_Upload.professor'
        db.add_column(u'main_test_upload', 'professor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Test_Upload.origin_term'
        db.add_column(u'main_test_upload', 'origin_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='test_origin_term', null=True, to=orm['main.Term']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Test_Upload.class_name'
        db.add_column(u'main_test_upload', 'class_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'Test_Upload.profile'
        db.delete_column(u'main_test_upload', 'profile_id')

        # Deleting field 'Test_Upload.course'
        db.delete_column(u'main_test_upload', 'course_id')

        # Deleting field 'Test_Upload.professor'
        db.delete_column(u'main_test_upload', 'professor')

        # Deleting field 'Test_Upload.origin_term'
        db.delete_column(u'main_test_upload', 'origin_term_id')
    ...
    models = {
        ...
        u'main.test_upload': {
            'Meta': {'ordering': "['course', 'professor']", 'object_name': 'Test_Upload'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tutoring.Class']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin_term': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'test_origin_term'", 'null': 'True', 'to': u"orm['main.Term']"}),
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 4, 22, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
