...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.test_upload'
        db.add_column(u'main_profile', 'test_upload',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PeerTeaching.emcc_complete'
        db.add_column(u'main_peerteaching', 'emcc_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.test_upload'
        db.delete_column(u'main_profile', 'test_upload')

        # Deleting field 'PeerTeaching.emcc_complete'
        db.delete_column(u'main_peerteaching', 'emcc_complete')
    ...
    models = {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 20, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
