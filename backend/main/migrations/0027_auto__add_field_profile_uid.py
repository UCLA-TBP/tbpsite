...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.uid'
        db.add_column(u'main_profile', 'uid',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.uid'
        db.delete_column(u'main_profile', 'uid')
    ...
    models = {
        ...
        u'main.profile': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
