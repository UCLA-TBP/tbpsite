...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveMember.peer_teaching'
        db.add_column(u'main_activemember', 'peer_teaching',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.PeerTeaching'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveMember.peer_teaching'
        db.delete_column(u'main_activemember', 'peer_teaching_id')
