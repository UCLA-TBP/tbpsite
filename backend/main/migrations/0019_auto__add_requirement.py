...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_requirement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('requirement_choice', self.gf('django.db.models.fields.CharField')(default='0', max_length=1)),
            ('event_hours', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Term'])),
        ))
        db.send_create_signal(u'main', ['Requirement'])

        # Adding M2M table for field event_requirements on 'ActiveMember'
        m2m_table_name = db.shorten_name(u'main_activemember_event_requirements')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activemember', models.ForeignKey(orm[u'main.activemember'], null=False)),
            ('requirement', models.ForeignKey(orm[u'main.requirement'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activemember_id', 'requirement_id'])

        # Adding M2M table for field event_requirements on 'Candidate'
        m2m_table_name = db.shorten_name(u'main_candidate_event_requirements')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('candidate', models.ForeignKey(orm[u'main.candidate'], null=False)),
            ('requirement', models.ForeignKey(orm[u'main.requirement'], null=False))
        ))
        db.create_unique(m2m_table_name, ['candidate_id', 'requirement_id'])


    def backwards(self, orm):
        # Deleting model 'Requirement'
        db.delete_table(u'main_requirement')

        # Removing M2M table for field event_requirements on 'ActiveMember'
        db.delete_table(db.shorten_name(u'main_activemember_event_requirements'))

        # Removing M2M table for field event_requirements on 'Candidate'
        db.delete_table(db.shorten_name(u'main_candidate_event_requirements'))
    ...
    models = {
        ...
        u'main.activemember': {
            ...
            'event_requirements': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.Requirement']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 18, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
