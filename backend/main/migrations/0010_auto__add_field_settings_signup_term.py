...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.signup_term'
        db.add_column(u'main_settings', 'signup_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='signup', null=True, to=orm['main.Term']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.signup_term'
        db.delete_column(u'main_settings', 'signup_term_id')
    ...
    models = {
        ...
        u'main.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiation_term': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'profile_initiation_term'", 'to': u"orm['main.Term']"}),
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
            ...
            'term': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['main.Term']"}),
