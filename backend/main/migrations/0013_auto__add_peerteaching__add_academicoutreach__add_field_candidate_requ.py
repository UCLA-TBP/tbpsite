...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PeerTeaching'
        db.create_table(u'main_peerteaching', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'main', ['PeerTeaching'])
        ...
        # Adding field 'Candidate.peer_teaching'
        db.add_column(u'main_candidate', 'peer_teaching',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.PeerTeaching'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PeerTeaching'
        db.delete_table(u'main_peerteaching')
        ...
        # Deleting field 'Candidate.peer_teaching'
        db.delete_column(u'main_candidate', 'peer_teaching_id')
    ...
    models = {
        ...
        u'main.academicoutreach': {
            'Meta': {'object_name': 'AcademicOutreach'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'main.activemember': {
