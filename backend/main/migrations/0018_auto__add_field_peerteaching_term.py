...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeerTeaching.term'
        db.add_column(u'main_peerteaching', 'term',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Term'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeerTeaching.term'
        db.delete_column(u'main_peerteaching', 'term_id')
