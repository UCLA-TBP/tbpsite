...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Test_Upload'
        db.create_table(u'main_test_upload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('class_name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('test_upload', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['Test_Upload'])


    def backwards(self, orm):
        # Deleting model 'Test_Upload'
        db.delete_table(u'main_test_upload')
    ...
    models = {
        ...
        u'main.test_upload': {
            'Meta': {'object_name': 'Test_Upload'},
            'class_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'test_upload': ('django.db.models.fields.files.FileField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'tutoring.class': {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 26, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
