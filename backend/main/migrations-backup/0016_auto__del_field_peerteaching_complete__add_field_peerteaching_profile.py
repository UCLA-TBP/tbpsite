...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PeerTeaching.profile'
        db.add_column(u'main_peerteaching', 'profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Profile'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PeerTeaching.profile'
        db.delete_column(u'main_peerteaching', 'profile_id')
    ...
    models = {
        ...
        u'main.peerteaching': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['main.Profile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'requirement_choice': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'tutoring': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tutoring.Tutoring']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'main.profile': {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 2, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
