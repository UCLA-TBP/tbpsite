...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HousePoints.signature_book'
        db.delete_column(u'main_housepoints', 'signature_book')

        # Deleting field 'HousePoints.candidate_quiz'
        db.delete_column(u'main_housepoints', 'candidate_quiz')


    def backwards(self, orm):
        # Adding field 'HousePoints.signature_book'
        db.add_column(u'main_housepoints', 'signature_book',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)

        # Adding field 'HousePoints.candidate_quiz'
        db.add_column(u'main_housepoints', 'candidate_quiz',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.housepoints': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'professor_interview': ('django.db.models.fields.CharField', [], {'default': "'4'", 'max_length': '1'}),
            'resume': ('django.db.models.fields.CharField', [], {'default': "'4'", 'max_length': '1'}),
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Term']"})
        },
        u'main.officer': {
