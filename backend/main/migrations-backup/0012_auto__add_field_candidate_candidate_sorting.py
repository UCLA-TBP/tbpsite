...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.candidate_sorting'
        db.add_column(u'main_candidate', 'candidate_sorting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.candidate_sorting'
        db.delete_column(u'main_candidate', 'candidate_sorting')
    ...
    models = {
        ...
        u'tutoring.tutoring': {
            ...
            'last_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Profile']"}),
