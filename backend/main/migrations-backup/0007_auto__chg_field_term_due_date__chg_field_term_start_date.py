...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Term.due_date'
        db.alter_column(u'main_term', 'due_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Term.start_date'
        db.alter_column(u'main_term', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Term.due_date'
        db.alter_column(u'main_term', 'due_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Term.start_date'
        db.alter_column(u'main_term', 'start_date', self.gf('django.db.models.fields.DateField')(default=None))
